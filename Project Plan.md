...
-  s5398289, William-Joseph Simons
   -  Project Plan Document, System Vision, Structural Design.
-  s5265839, Ben Lange
...
| 3.1                                  | Implement the GUI                                  | Implement the graphical user interface. This includes using wxFormBuilder to develop the layout.                                                                                                         | 3               | Braith Lee               |
| 3.2                                  | Implement Food Search Feature                      | Code all the functions that enable the user to search for foods by name. Including the event that calls the nutrition breakdown feature.                                                                 | 3               | William-Joseph           |
| 3.3                                  | Implement Nutrition Breakdown Feature              | Code all the functions that enable the user to see pie charts and bar graphs that display the nutritional breakdown of the selected food.                                                                | 3               | Braith Lee               |
| 3.4                                  | Implement Nutrition Range Filter Feature           | Code all the functions that enable the user to see a list of food filtered by a minimum and maximum range of a specific nutrient.                                                                        | 3               | William-Joseph           |
| 3.5                                  | Implement Nutrition Level Filter Feature           | Code all the functions that enable the user to see a list of foods filtered by low, mid, or high levels of a selected nutrient.                                                                          | 3               | Ben Lange                |
| 3.6                                  | Implement Food Wars Feature                        | Code all the functions that allow the user to compare up to 5 different foods against a chosen nutrient and the chart to compare the different foods.                                                    | 3               | Ben Lange                |
| <span style="color:red;">3.7 </span> | <span style="color:red;">Executive Summary </span> | Perform testing on the code to ensure there are no bugs and that the code meets the scope.                                                                                                               | 5               | Braith Lee               |
| 3.8                                  | Unit Testing and Report                            | Perform testing on the code to ensure there are no bugs and that the code meets the scope.                                                                                                               | 5               | Braith Lee               |
| 3.9                                  | Coverage Testing and Report                        | Perform testing on the code to ensure there are no bugs and that the code meets the scope.                                                                                                               | 5               | Braith Lee               |
| 4.1                                  | Track Progress                                     | Monitor the progress of the project to ensure it keeps pace with timelines and milestones.                                                                                                               | Ongoing         | Ben Lange                |
| 4.2                                  | Control Scope                                      | Ensure the progress stays within the scope by managing changes made.                                                                                                                                     | Ongoing         | William-Joseph           |
| 4.3                                  | Control Quality                                    | Ensure the application meets high standards by conducting reviews against the rubric.                                                                                                                    | Ongoing         | William-Joseph           |
| 4.4                                  | Monitor Bugs                                       | Track known bugs that are found during testing. Manage the bugs to ensure stability of the application.                                                                                                  | Ongoing         | Ben Lange                |
