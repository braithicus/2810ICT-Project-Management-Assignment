...
-  s5264208, Braith Lee
   -  Stakeholder Classifications and Additions, Requirements Section, Wireframes, General Fixes
...
| 2.7.1                                | Design the Structure                                         | Present a structural design, a hierarchy chart, showing the overall interface’s structure.                                                                                                               | 2                                  | William-Joseph                                 |
...
| 3.1                                  | Implement the GUI                                            | Implement the graphical user interface. This includes using wxFormBuilder to develop the layout.                                                                                                         | <span style="color:red;">12</span> | <span style="color:red;">Braith and Ben</span> |
| 3.2                                  | Implement Food Search Feature                                | Code all the functions that enable the user to search for foods by name. Including the event that calls the nutrition breakdown feature.                                                                 | <span style="color:red;">1</span>  | William-Joseph                                 |
| 3.3                                  | Implement Nutrition Breakdown Feature                        | Code all the functions that enable the user to see pie charts and bar graphs that display the nutritional breakdown of the selected food.                                                                | <span style="color:red;">15</span> | <span style="color:red;">William-Joseph</span> |
| 3.4                                  | Implement Nutrition Range Filter Feature                     | Code all the functions that enable the user to see a list of food filtered by a minimum and maximum range of a specific nutrient.                                                                        | <span style="color:red;">4</span>  | William-Joseph                                 |
| 3.5                                  | Implement Nutrition Level Filter Feature                     | Code all the functions that enable the user to see a list of foods filtered by low, mid, or high levels of a selected nutrient.                                                                          | <span style="color:red;">4</span>  | <span style="color:red;">William-Joseph</span> |
| 3.6                                  | Implement Food Wars Feature                                  | Code all the functions that allow the user to compare up to 5 different foods against a chosen nutrient and the chart to compare the different foods.                                                    | <span style="color:red;">6</span>  | Ben Lange                                      |
| <span style="color:red;">3.7 </span> | <span style="color:red;">Executive Summary </span>           | <span style="color:red;"> Add step by step instructions on how to use each feature and any additional instructions. </span>                                                                              | <span style="color:red;">1</span>  | Braith Lee                                     |
| <span style="color:red;">3.8</span>  | <span style="color:red;">Unit Testing and Report</span>      | <span style="color:red;"> Perform unit testing on the code to ensure there are no bugs and that the code meets the scope. Also recording everything in the testing document.</span>                      | <span style="color:red;">8</span>  | <span style="color:red;">William-Joseph</span> |
| <span style="color:red;">3.9 </span> | <span style="color:red;">Coverage Testing and Report </span> | <span style="color:red;">Perform coverage testing on the code to ensure the tests cover all the code. Also recording everything in the testing document.</span>                                          | <span style="color:red;">2</span>  | <span style="color:red;">William-Joseph</span> |
| 4.1                                  | Track Progress                                               | Monitor the progress of the project to ensure it keeps pace with timelines and milestones.                                                                                                               | Ongoing                            | <span style="color:red;">All</span>            |
| 4.2                                  | Control Scope                                                | Ensure the progress stays within the scope by managing changes made.                                                                                                                                     | Ongoing                            | <span style="color:red;">All</span>            |
| 4.3                                  | Control Quality                                              | Ensure the application meets high standards by conducting reviews against the rubric.                                                                                                                    | Ongoing                            | <span style="color:red;">All</span>            |
| 4.4                                  | Monitor Bugs                                                 | Track known bugs that are found during testing. Manage the bugs to ensure stability of the application.                                                                                                  | Ongoing                            | <span style="color:red;">All</span>            |
...
<span style="color:red;"> Gantt Chart is now fully filled out </span>
